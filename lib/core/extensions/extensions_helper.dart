...
extension NamedRouteExtension on BuildContext {
  void push(String routeName, {Object? arguments, Function? onReturn}) {
    Navigator.of(this)
        .pushNamed(routeName, arguments: arguments)
        .then((value) => onReturn?.call(value));
  }
...
extension MediaQueryExtension on BuildContext {
  ...
  double get keyboardHeightWithoutAppBarAndBarAndSafeArea =>
      ...
      MediaQuery.of(this).padding.top -
      MediaQuery.of(this).padding.bottom;
  double get keyboardHeightWithoutAppBarAndBarAndSafeAreaAndTextScaleFactor =>
      MediaQuery.of(this).viewInsets.bottom -
      appBarHeight -
      navigationBarHeight -
      MediaQuery.of(this).padding.top -
      ...
      textScaleFactor;
  double
      get keyboardHeightWithoutAppBarAndBarAndSafeAreaAndTextScaleFactorAndStatusBar =>
          MediaQuery.of(this).viewInsets.bottom -
          appBarHeight -
          navigationBarHeight -
          MediaQuery.of(this).padding.top -
          ...
          statusBarHeight;
  double
      get keyboardHeightWithoutAppBarAndBarAndSafeAreaAndTextScaleFactorAndStatusBarAndNavigationBar =>
          MediaQuery.of(this).viewInsets.bottom -
          appBarHeight -
          navigationBarHeight -
          MediaQuery.of(this).padding.top -
  ...
  showCustomBottomSheet<T>(Widget bottomSheet,
    ...
    if (scaffoldKey != null) {
      return scaffoldKey.currentState!
          .showBottomSheet<T>((context) => bottomSheet);
    }
